...
When considering the search engine to use, full-text has some important limitations. This configuration can also be applied for `File`, however it unfortunately does not support any further customisation.
